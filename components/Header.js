...
const Header = () => {
  return (
    <View style={styles.viewStyle}>
      <View style={{backgroundColor:"#6231AD"}}>
        <View style={styles.topContainerStyle}>
          <View style={styles.headerView}>
            ...
            <View style={styles.timingsView}>
              ...
              <Text style={styles.timings}>03:23:21</Text>
            </View>
          </View>
          <View style={styles.infoPrice}>
            <View>
              <Text style={styles.bitCoinPriceInfo}>
                Bitcoin price will be under
              </Text>
              <Text style={{ color: "white" }}>
                <Text style={styles.bitCoinPrice}>$24,524</Text>
            ...
            <View style={styles.bgImage}>
              <Image source={require("../assets/images/bitcoinbg.png")} />
            </View>
          </View>
        </View>
      </View>
